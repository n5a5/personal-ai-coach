...
export default function CoachPage() {
  ...
  return (
    <main className="coach-page" style={{ maxWidth: 850, margin: "0 auto", padding: "24px 16px 40px", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      <header className="coach-page-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, marginBottom: 14 }}>
      ...
      <div className="coach-thread" style={{ flex: 1, background: "white", borderRadius: 20, padding: 16, minHeight: 420, overflowY: "auto" }}>

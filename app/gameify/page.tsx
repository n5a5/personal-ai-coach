  ...
  return (
    <main style={{ maxWidth: 980, margin: "0 auto", padding: "28px 20px 120px", color: "#171717" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", gap: 20, marginBottom: 24, flexWrap: "wrap" }}>
        <div><div style={{ fontSize: 12, letterSpacing: 2, fontWeight: 800, color: "#6B6B6B" }}>MOMENTUM</div><h1 style={{ fontSize: 42, margin: "6px 0" }}>Build evidence.</h1><p style={{ margin: 0, color: "#6B6B6B" }}>The goal isn't points. The goal is becoming the person you want to be.</p></div>
